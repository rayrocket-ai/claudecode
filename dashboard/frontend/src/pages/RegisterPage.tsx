    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200 mt-2">Get started with your social media dashboard</p>
        </div>
        ...
        <p className="text-center text-xs text-blue-300/60 mt-6">
          Demo mode is active. All platforms will be auto-connected with sample data.
        </p>
      </div>
    </div>
  );
